...
def craiglockhart_and_tollcross
  ...
  JOIN
    ...
    AND start_routes.num = end_routes.num
  JOIN
      stops AS stopa ON stopa.id = start_routes.stop_id
  JOIN
      stops AS destination ON destination.id = end_routes.stop_id
  WHERE
    stopa.name = 'Craiglockhart' 
    AND destination.name = 'Tollcross'  
