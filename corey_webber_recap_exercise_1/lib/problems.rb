...
class Hash
    ...
    def my_select(&prc) #if doesn't pass in prc will default to nil 
        prc ||= Proc.new {|k, v| k == v}    #default or equals
        new_hash = {}

        self.each do |k, v|
            new_hash[k] = v if prc.call(k, v)   #similar to shoveling 
        end
...
class String
    ...
    def caesar_cipher(num)
        ...
        self.each_char do |char|
            start_position = alpha.index(char)
